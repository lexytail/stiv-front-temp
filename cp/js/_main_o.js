...
//    var sidebar = maindiv.appendChild(createSideBar());
    ...
    $('.tarif').html('<div class="container"><div class="head"><div class="name">Тариф: <span>'+tariff.name+'</span></div><div class="days">Осталось <span>'+getSubscriptionTime()+'</span></div></div><div class="scale"><div class="blue"></div></div></div>');
    ...
    */
    ...
    function createWrapper(){
        ...
        */
        ...
        $wrap = $(wrap);
        $wrap.addClass('gx-main-container');

        var header = document.createElement("header");
        $header = $(header);
        $header.addClass('gx-main-container');
        ...
        */
        ...
        /*
        wrap.id = "wrap";
        wrap.className = 'gx-main-container';
    ...
    function createSideBar(){
        ...
        var sidebar = sidebar1.appendChild(div('', 'container'));
        var effects = new Array();
...
function setActiveMenu(page){
    ...
    var actives = menu.getElementsByClassName("active");
    for(var i in actives){
//        if(actives[i].id != 'subgroup')
            actives[i].className = null;
    }
